    ...
    async def on_message(self, message):
        ...
        if user_data["napping"]:
            ...
            embed = discord.Embed(
                ...
                description=f"Welcome back {message.author.mention}, you're no longer napping and users can ping you now.",
                color=discord.Color.nitro_pink()
            )
            embed.set_footer(text=f"You can now ping {message.author.name} again!")
